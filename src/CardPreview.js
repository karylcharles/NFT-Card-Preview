...
import equilImg from './images/image-equilibrium.jpg';
    ...
    render(){
        return(
            <div className='CardPreview'>
                <div className='CardPreview-imgContainer'>
                    <img src={equilImg} alt="equilibrium image"/>
                    <div className='CardPreview-imgContainer__view'>
                ...
                <div className="CardPreview-content">
                    <h3 className='CardPreview-title'>Equilibrium #3429</h3>
                    <p className='CardPreview-subtext'>Our equilibrium collection promotes balance and calm.</p>
                    <div className='CardPreview-factors'>
                        <div>
                            <svg width="11" height="18" xmlns="http://www.w3.org/2000/svg"><path d="M11 10.216 5.5 18 0 10.216l5.5 3.263 5.5-3.262ZM5.5 0l5.496 9.169L5.5 12.43 0 9.17 5.5 0Z" fill="#00FFF8"/></svg>
                            <span className='CardPreview-factors__eth'>0.041 ETH</span>
                        </div>
                        <div>
                            ...
                            <span className='CardPreview-factors__days'>3 days left</span>
                        </div>
                    </div>
                    <div className='author-container'>
                        <div className='author-container__img-container'>
                            <img src={authorImg} alt="author"/>
                        </div>
                        <p className='author-container__text'>Creation of <span className='author-container__sub'>Jules Wyvern</span></p>
                    </div>
                </div>
            </div>
        );
